...
- Python 3.11+ + Git CLI synchronization, lower-privilege cloud/local node split, HTTPS Odoo health checks, and modular Platinum Agent Skills. (005-distributed-ai-employee)

## Recent Changes
- 005-distributed-ai-employee: Added Platinum distributed architecture planning for Git-based vault sync, cloud/local orchestration, HTTPS Odoo health monitoring, and modular Agent Skills.
